...
Here we learn about __binding__ environments, and _special environments_: __package__, __namespace__, __function__, __execution__, and __caller__ environments. 

We also learn how to work with _environments as data structures_.
...
If you try to print an environment, you won't see any useful information (just the memory address). Instead, we use `rlang::env_print()`.
